    ...
    <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
      <div class="list_box">
        ...
        <div class="product_list product_list2">
          @foreach($list as $vo)
          <div class="col-sm-4 col-md-3 col-mm-6 product_img"><a href="/chaye.com/laravel/public/product/list/{{$vo->id}}"><img  src="/{{$vo->avatar}}" class="img-thumbnail" alt="{{$vo->name}}"/></a>
