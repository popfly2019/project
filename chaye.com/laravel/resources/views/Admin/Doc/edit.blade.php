...
@include('Admin.Common.menu')
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>编辑档案</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="/chaye.com/laravel/public/admin/doc" class="actionBtn">档案列表</a>编辑档案</h3>
    <form action="{{url('admin/doc/update',$manage->id)}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
