...
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加产品</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="/chaye.com/laravel/public/admin/admin" class="actionBtn">产品列表</a>添加产品</h3>
    <form action="/chaye.com/laravel/public/admin/product/store" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      ...
      <tr>
       ...
       <td>
        <input type="text" name="ip" value="<?php echo rand(1000000,9999999)?>" size="80" class="inpMain" />
       </td>
      </tr>
      <tr>
