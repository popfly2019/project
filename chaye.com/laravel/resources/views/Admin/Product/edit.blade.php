...
@include('Admin.Common.menu')
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>编辑产品</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="/chaye.com/laravel/public/admin/admin" class="actionBtn">产品列表</a>编辑产品</h3>
    <form action="{{url('admin/product/update',$manage->id)}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      ...
      <tr>
       <td width="90" align="right">产品编号</td>
       <td>
        <input type="text" name="ip" value="{{$manage->ip}}" size="80" class="inpMain" />
       </td>
      </tr>
      <tr>
      ...
      <tr>
       <td align="right" valign="top">产品内容</td>
       <td>
        <!-- KindEditor -->
