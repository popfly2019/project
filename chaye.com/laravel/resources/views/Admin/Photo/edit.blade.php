...
@include('Admin.Common.menu')
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>编辑相册</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="/chaye.com/laravel/public/admin/photo" class="actionBtn">相册列表</a>编辑相册</h3>
    <form action="{{url('admin/photo/update',$manage->id)}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
