...
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加新闻</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="/chaye.com/laravel/public/admin/article" class="actionBtn">新闻列表</a>添加新闻</h3>
    <form action="/chaye.com/laravel/public/admin/article/store" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
