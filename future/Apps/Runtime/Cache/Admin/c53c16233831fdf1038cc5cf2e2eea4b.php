  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="<?php echo U('nav/add');?>">增加导航</a></li>
        </ol>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-list"></span> <span class="visible-lg">链接</span></th>
                <th class="hidden-sm"><span class="glyphicon glyphicon-tag"></span> <span class="visible-lg">模板</span></th>
                <th class="hidden-sm"><span class="glyphicon glyphicon-comment"></span> <span class="visible-lg">推荐</span></th>
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">开关</span></th>
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
                ...
                <td class="article-title"><?php echo ($list["name"]); ?></td>
                <td><?php echo ($list["url"]); ?></td>
                <td class="hidden-sm"><?php echo ($list["module"]); ?></td>
                <td class="hidden-sm">
                  <?php if($list['top'] == '1'): ?>推荐
                  <?php else: ?>
                    正常<?php endif; ?>
                </td>
                <td>
                  <?php if($list['open'] == '1'): ?>开启
                  <?php else: ?>
                    关闭<?php endif; ?>
                </td>
                <td><a href="<?php echo U('nav/edit',array('id'=>$list['id']));?>" class="UrLink">修改</a> <a rel="6">删除</a></td>
...
$(function(){
  $(".UrLink").click(function(){
    var link = $(this).attr('href');
    $.ajax({
      type:"post",
      url:"<?php echo U('Nav/edit');?>",
      dataType:"json",
      data:"link=" + link,
    })
  })
