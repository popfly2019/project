    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="<?php echo U('Category/add');?>" method="post" class="add-article-form">
          <div class="col-md-9">
            <h1 class="page-header">新分类</h1>
            <div class="form-group">
              <label for="article-title" class="sr-only">名称</label>
              <input type="text" id="article-title" name="name" class="form-control" placeholder="在此处输入分类名称" required autofocus autocomplete="off">
            </div>
          </div>
          <div class="col-md-3">
