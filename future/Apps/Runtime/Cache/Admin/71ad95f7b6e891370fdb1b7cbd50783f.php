        ...
        <div class="col-md-12">
			<div class="panel">
                <div class="panel-heading">
                  ...
                  <a href="<?php echo U('news/add');?>" class="btn btn-info btn-gradient pull-right"><span class="glyphicons glyphicon-plus"></span> 添加文章</a>
                </div>
                ...
                <div class="panel-body">
                  ...
                  <table class="table table-striped table-bordered table-hover dataTable">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr class="success">
                        ...
                        <td>
		                      <div class="btn-group">
		                        <a href="<?php echo U('news/edit',array('id'=>$list['id']));?>" class="btn btn-default btn-gradient"><span class="glyphicons glyphicon-pencil"></span></a>
		                        <a href="<?php echo U('news/delete',array('id'=>$list['id']));?>" class="btn btn-default btn-gradient dropdown-toggle"><span class="glyphicons glyphicon-trash"></span></a>
		                      </div>
