...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="<?php echo U('Category/add');?>" method="post" class="add-article-form">
          <div class="col-md-9">
            <h1 class="page-header">修改分类</h1>
            <div class="form-group">
              <label for="article-title" class="sr-only">名称</label>
              <input type="text" id="article-title" name="name" class="form-control" placeholder="在此处输入分类名称" required autofocus autocomplete="off" value="<?php echo ($manage["name"]); ?>">
            </div>
          </div>
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <ul class="category-list">
                  <?php if($manage['cateid'] == '1'): ?><li>
                      <label>
                        <input name="cateid" type="radio" value="1" checked>
                        动态 <em class="hidden-md">( ID: <span>1</span> )</em></label>
                    </li>
                    <li>
                      <label>
                        <input name="cateid" type="radio" value="2">
                        案例 <em class="hidden-md">( ID: <span>2</span> )</em></label>
                    </li>
                  <?php else: ?>
                    <li>
                      <label>
                        <input name="cateid" type="radio" value="1">
                        动态 <em class="hidden-md">( ID: <span>1</span> )</em></label>
                    </li>
                    <li>
                      <label>
                        <input name="cateid" type="radio" value="2" checked>
                        案例 <em class="hidden-md">( ID: <span>2</span> )</em></label>
                    </li><?php endif; ?>
                </ul>
              </div>
