...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style>
			.news_list img{width: 64px;height: 64px;}
		</style>
	</head>
	<body>
		<style>
				...
				<div class="description">
					<ul class="news_list">
						<?php if(is_array($list)): foreach($list as $key=>$list): ?><li>
								<p class="time">Update<br /><?php echo (date("Y-m-d",$list["date"])); ?></p>
								<div class="title">
									<h3><a href="<?php echo U('news/'.$list['id']);?>"><?php echo ($list["name"]); ?></a></h3>
									<a href="news_detail.html" class="more"><img src="/tyweb/Public/Home/img/news/more.gif" /></a>
									<div class="clear"></div>
								</div>
								<div class="clear"></div>
								<img class="illustrantion" src="/<?php echo ($list["img"]); ?>" title="图片" alt="图片"/>
