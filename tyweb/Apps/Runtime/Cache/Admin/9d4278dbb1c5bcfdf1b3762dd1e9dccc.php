          ...
          <div class="col-md-9">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" id="flink-name" name="name" class="form-control" placeholder="在此处输入名称" required autofocus autocomplete="off" value="<?php echo ($manage["name"]); ?>">
                <span class="prompt-text"></span> </div>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>密码</span></h2>
              <div class="add-article-box-content">
                <input type="password" id="flink-password" name="password" class="form-control" placeholder="在此处输入密码" required autocomplete="off" value="<?php echo ($manage["password"]); ?>">
                <span class="prompt-text"></span> </div>
            </div>
            <div class="add-article-box">
             ...
             <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" id="flink-qq" name="qq" class="form-control" placeholder="在此处输入QQ" required autocomplete="off" value="<?php echo ($manage["qq"]); ?>">
                <span class="prompt-text">选填</span> </div>
            </div>
             <div class="add-article-box">
              <h2 class="add-article-box-title"><span>邮箱</span></h2>
              <div class="add-article-box-content">
                <input type="text" id="flink-email" name="email" class="form-control" placeholder="在此处输入密码" required autocomplete="off" value="<?php echo ($manage["email"]); ?>">
                <span class="prompt-text">选填</span> </div>
            </div>
          </div>
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                  ...
                  <input style="border: none;" type="datetime" readonly="readonly" name="date" value="<?php echo date('Y-m-d H:i:s',time())?>" />
                  </span></p>
              </div>
              <div class="add-article-box-footer">
