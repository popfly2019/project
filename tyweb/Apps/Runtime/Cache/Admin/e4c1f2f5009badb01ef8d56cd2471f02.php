...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <h1 class="page-header">操作</h1>
        <ol class="breadcrumb">
          <li><a data-toggle="modal" data-target="#addUser" href="<?php echo U('admin/add');?>">增加用户</a></li>
        </ol>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-pushpin"></span> <span class="visible-lg">图片</span></th>
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">创建时间</span></th>
                <th><span class="glyphicon"></span> <span class="visible-lg">QQ</span></th>
                <th><span class="glyphicon"></span> <span class="visible-lg">邮箱</span></th>
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
                ...
                <td><a href="/<?php echo ($list["img"]); ?>" target="_blank"><?php echo ($list["img"]); ?></a></td>
                <td><?php echo ($list["date"]); ?></td>
                <td><?php echo ($list["qq"]); ?></td>
                <td><?php echo ($list["email"]); ?></td>
                <td><a rel="1" name="see" href="<?php echo U('admin/edit',array('id'=>$list['id']));?>">修改</a> <a rel="1" name="delete" href="<?php echo U('uadmin/delete',array('id'=>$list['id']));?>">删除</a> <a href="#">禁用</a></td>
