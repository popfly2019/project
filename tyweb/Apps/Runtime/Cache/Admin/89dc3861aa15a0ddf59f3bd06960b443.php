    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="" method="post" class="add-article-form">
          <div class="col-md-9">
            <h1 class="page-header">新导航</h1>
            <div class="form-group">
              <label for="article-title" class="sr-only">名称</label>
              <input type="text" id="article-title" value="<?php echo ($manage["name"]); ?>" name="name" class="form-control" placeholder="在此处输入名称" required autofocus autocomplete="off">
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>URL</span></h2>
              <div class="add-article-box-content">
              	<input type="text" class="form-control" placeholder="请输入网页URL" name="url" autocomplete="off" value="<?php echo ($manage["url"]); ?>">
                <span class="prompt-text">用于网页跳转。</span>
              </div>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>模板</span></h2>
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="请输入模板信息" name="module" autocomplete="off" value="<?php echo ($manage["module"]); ?>">
                <span class="prompt-text">记录网页所用模板。</span>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>开关</span></h2>
              <div class="add-article-box-content">
                <ul class="category-list">
                  <?php if($manage['open'] == '1'): ?><li>
                      <label>
                        <input name="open" type="radio" value="1" checked>
                        开启 <em class="hidden-md">( ID: <span>1</span> )</em></label>
                    </li>
                    <li>
                      <label>
                        <input name="open" type="radio" value="2">
                        关闭 <em class="hidden-md">( ID: <span>2</span> )</em></label>
                    </li>
                  <?php else: ?>
                    <li>
                      <label>
                    ...
                    <li>
                      <label>
                        <input name="open" type="radio" value="2" checked>
                        关闭 <em class="hidden-md">( ID: <span>2</span> )</em></label>
                    </li><?php endif; ?>
                </ul>
              </div>
            ...
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>推荐</span></h2>
              <div class="add-article-box-content">
                <ul class="category-list">
                  <li>
                    <label>
                      <input name="top" type="radio" value="1" checked>
                      推荐 <em class="hidden-md">( ID: <span>1</span> )</em></label>
                  </li>
                  <li>
                    <label>
                      <input name="top" type="radio" value="2">
                      正常 <em class="hidden-md">( ID: <span>2</span> )</em></label>
                  </li>
                </ul>
              </div>
            </div>
