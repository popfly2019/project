...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="<?php echo U('Nav/add');?>" method="post" class="add-article-form">
          <div class="col-md-9">
            <h1 class="page-header">新导航</h1>
            <div class="form-group">
              <label for="article-title" class="sr-only">名称</label>
              <input type="text" id="article-title" name="name" class="form-control" placeholder="在此处输入名称" required autofocus autocomplete="off">
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>URL</span></h2>
              <div class="add-article-box-content">
              	<input type="text" class="form-control" placeholder="请输入网页URL" name="url" autocomplete="off">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="请输入模板信息" name="module" autocomplete="off">
