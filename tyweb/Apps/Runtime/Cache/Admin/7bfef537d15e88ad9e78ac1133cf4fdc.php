        ...
        <form action="" method="post" class="add-article-form">
          <div class="col-md-9">
            ...
            <div class="form-group">
              ...
              <input type="text" id="article-title" name="name" class="form-control" placeholder="在此处输入标题" required autofocus autocomplete="off" value="<?php echo ($manage["name"]); ?>">
            </div>
            <div class="form-group">
              <label for="article-content" class="sr-only">内容</label>
              <script id="article-content" name="content" type="text"><?php echo (htmlspecialchars_decode($manage["content"])); ?></script>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>关键字</span></h2>
              <div class="add-article-box-content">
              	<input type="text" class="form-control" placeholder="请输入关键字" name="keywords" autocomplete="off" value="<?php echo ($manage["keywords"]); ?>">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="描述" name="description" autocomplete="off" value="<?php echo ($manage["description"]); ?>">
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <ul class="category-list">
                  <?php if(is_array($category)): foreach($category as $key=>$cate): ?><li>
                    <label>
                      <input name="cateid" type="radio" value="<?php echo ($cate["id"]); ?>" <?php echo ($manage['cateid']==$cate['id']?"checked":""); ?>>
                      <?php echo ($cate["name"]); ?> <em class="hidden-md">( 栏目ID: <span><?php echo ($cate["id"]); ?></span> )</em></label>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="点击按钮选择图片" id="pictureUpload" name="img" autocomplete="off" value="<?php echo ($manage["img"]); ?>">
              </div>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <p><label>发布于：</label><span class="article-time-display"><input style="border: none;" type="datetime" name="time" value="<?php echo date('Y-m-d h:i:s', time());?>" /></span></p>
              </div>
              <div class="add-article-box-footer">
