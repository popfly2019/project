  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="<?php echo U('page/add');?>">增加单页</a></li>
        </ol>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-th-large"></span> <span class="visible-lg">单页名称</span></th>
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
                ...
                <td><a href="<?php echo U('page/edit',array('id'=>$list['id']));?>">修改</a> <a href="<?php echo U('page/delete',array('id'=>$list['id']));?>">删除</a></td>
