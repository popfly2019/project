  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="<?php echo U('news/add');?>">增加文章</a></li>
        </ol>
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
                ...
                <td><?php echo ($list["cateid"]); ?></td>
                <td><?php echo (date("Y-m-d H:i:s",$list["date"])); ?></td>
                <td><a href="<?php echo U('news/edit',array('id'=>$list['id']));?>">修改</a> <a href="<?php echo U('news/delete',array('id'=>$list['id']));?>">删除</a></td>
