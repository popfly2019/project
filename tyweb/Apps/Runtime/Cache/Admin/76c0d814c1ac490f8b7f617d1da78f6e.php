  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Flink/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="<?php echo U('ad/add');?>">增加图片</a></li>
        </ol>
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
                ...
                <td><a href="<?php echo U('ad/edit',array('id'=>$list['id']));?>">修改</a> <a href="<?php echo U('ad/delete',array('id'=>$list['id']));?>">删除</a></td>
