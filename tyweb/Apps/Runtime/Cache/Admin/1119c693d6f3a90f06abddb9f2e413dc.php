  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="<?php echo U('Category/add');?>">增加分类</a></li>
        </ol>
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
                ...
                <td class="article-title">
                  <?php if($list['cateid'] == '1'): ?>动态
                  <?php else: ?>
                      案例<?php endif; ?>
                </td>
                <td><a href="<?php echo U('Category/edit',array('id'=>$list['id']));?>" class="UrLink">修改</a> <a href="<?php echo u('Category/delete',array('id'=>$list['id']));?>">删除</a></td>
